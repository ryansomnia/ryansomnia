...
const ProjectSection = () => {
  return (
    <section id="projects" className="bg-[#0a0a0a] py-24 px-6 lg:px-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {projects.map((project) => (
            <div key={project.number} className="group relative bg-[#111] border border-white/[0.06] rounded-sm overflow-hidden hover:border-emerald-300/30 transition-colors duration-300">
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-base font-medium text-[#f0ede6] mb-2">{project.title}</h3>
